...
class SpecimenSide: OpMode() {
    fun GeneratedPath(): PathChain {
        ...
        builder
            .addPath( // Line 1
                BezierLine(
                    Point(135.000, 74.000, Point.CARTESIAN),
                    Point(105.684, 74.000, Point.CARTESIAN) // change to 105
                )
            )
            .setZeroPowerAccelerationMultiplier(2.0)
            .addPath(
                BezierCurve(
                    Point(135.0, 74.0, Point.CARTESIAN),
                    Point(138.0, 80.0, Point.CARTESIAN),
                    Point(140.0, 140.0, Point.CARTESIAN)
                )
            )
